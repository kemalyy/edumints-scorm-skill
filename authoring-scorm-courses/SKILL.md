...
- `references/mcp-cookbook.md` — exact tool calls, full build_from_spec shape (all 19 screen types) + the feedback loop.
...
- `references/screen-types.md` — decision guide for all 19 screen types (incl. simulation, decision_scenario).
